...
**Goal:** Transformer `/catalogue/produits/$productId` en fiche « consulter d'abord » : synthèse chiffrée, stock par entrepôt (nouvel endpoint), identité à gauche, variantes avec lots imbriqués à droite, édition en place par section.
...
**Tech Stack:** Hono 4 + Drizzle/D1 (tests intégration D1 réelle), React 19 + TanStack Query + Testing Library/jsdom, composants DS existants (Table, Combobox, Input, Badge).
...
**Files:**
- Test (create): `apps/api/test/product-stock.test.ts`
- Modify: `apps/api/src/routes/products.ts` (après le handler `GET /:id`, ~ligne 144)
...
**Files:**
- Create: `apps/web/src/components/produit/section-synthese.tsx`
- Test (create): `apps/web/src/components/produit/section-synthese.test.tsx`
...
**Files:**
- Create: `apps/web/src/components/produit/section-identite.tsx`
- Test (create): `apps/web/src/components/produit/section-identite.test.tsx`
- Delete (à la Task 6, après bascule de la page) : `section-infos.tsx`, `section-image.tsx`
...
**Files:**
- Create: `apps/web/src/components/produit/section-stock.tsx`
- Test (create): `apps/web/src/components/produit/section-stock.test.tsx`
- Modify: `apps/web/src/components/produit/types.ts` (ajouter `LigneStockProduit`)
...
- [ ] **Step 1 : Ajouter le type dans `types.ts`**
...
- [ ] **Step 3 : Implémenter l'imbrication**
...
**Files:**
- Modify: `apps/web/src/routes/_app/catalogue/produits/$productId.tsx` (réécriture)
- Delete: `apps/web/src/components/produit/section-infos.tsx`, `section-image.tsx`, `section-lots.tsx`
- Test (create): `apps/web/src/components/produit/fiche-produit.test.tsx`
...
- [ ] **Step 1 : Écrire le test de page (échec attendu)**
...
- [ ] **Step 4 : Vérifier le passage et l'absence de références mortes**
...
- [ ] **Step 2 : E2E navigateur (agent-browser, serveurs dev lancés)**
...
- [ ] **Step 3 : Captures avant/après pour la PR**
