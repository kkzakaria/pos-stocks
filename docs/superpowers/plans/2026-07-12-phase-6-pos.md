...
// `<main className="print:hidden">` masque tout son sous-arbre à
// l'impression : SANS portail, le ticket hérite de ce `display:none` et
// l'impression sort blanche. `createPortal` sort le ticket vers
// `document.body`, hors du sous-arbre masqué.
